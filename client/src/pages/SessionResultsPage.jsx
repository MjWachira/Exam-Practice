...
export default function SessionResultsPage({ session, onRetake, onBackToDashboard }) {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-10 pb-20 animate-fade-in">
      ...
      {/* RESULT HERO CARD */}
      <section className="glass-panel p-8 sm:p-10 rounded-3xl border border-slate-200 dark:border-slate-700/60 shadow-2xl relative overflow-hidden text-center space-y-6">
        ...
        {/* METRICS ROW */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-2xl mx-auto pt-4 border-t border-slate-200 dark:border-slate-800">
          <div className="p-3 bg-slate-100/80 dark:bg-slate-900/60 rounded-xl border border-slate-200 dark:border-slate-800">
            <p className="text-[10px] text-slate-500 dark:text-slate-400 uppercase font-semibold">Exam Mode</p>
            <p className="text-xs font-bold text-slate-800 dark:text-slate-200 capitalize">{session.mode || 'Practice'}</p>
          </div>
          <div className="p-3 bg-slate-100/80 dark:bg-slate-900/60 rounded-xl border border-slate-200 dark:border-slate-800">
            <p className="text-[10px] text-slate-500 dark:text-slate-400 uppercase font-semibold">Time Spent</p>
            <p className="text-xs font-bold text-slate-800 dark:text-slate-200">{minutesTaken}m {secondsTaken}s</p>
          </div>
          <div className="p-3 bg-slate-100/80 dark:bg-slate-900/60 rounded-xl border border-slate-200 dark:border-slate-800">
            <p className="text-[10px] text-slate-500 dark:text-slate-400 uppercase font-semibold">CSM Benchmark</p>
            <p className="text-xs font-bold text-emerald-600 dark:text-emerald-400">74% Minimum</p>
          </div>
          <div className="p-3 bg-slate-100/80 dark:bg-slate-900/60 rounded-xl border border-slate-200 dark:border-slate-800">
            <p className="text-[10px] text-slate-500 dark:text-slate-400 uppercase font-semibold">Candidate</p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
          ...
          <button
            ...
            className="px-6 py-3 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700 text-xs font-bold flex items-center space-x-2 transition-all"
          >
      ...
      <section className="space-y-4">
        <h3 className="text-lg font-extrabold text-slate-900 dark:text-slate-100">Session Scrum Domain Breakdown</h3>
      ...
      <section className="space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <h3 className="text-lg font-extrabold text-slate-900 dark:text-slate-100">Detailed Question Audit</h3>
          ...
          {/* Filter Pills */}
          <div className="flex items-center space-x-2 bg-slate-100 dark:bg-slate-900 p-1 rounded-xl border border-slate-200 dark:border-slate-800 text-xs font-bold">
            <button
                ...
                >
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <h4 className="text-sm font-bold text-slate-900 dark:text-slate-100 leading-snug">{item.question}</h4>
                    </div>
                  </div>

                  <button className="p-1 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200">
